...
# )
    ...
    template = (
        ...
        f"""{{
      "content_geo_evaluation": {{
        "strengths": ["<brief descriptions of what is done well>"],
        "improvements": [
          {{
            "problem_area": "<the specific part that needs improvement or is problematic>",
            "suggestion": "<a clear and actionable improvement>"
          }},
          ...
        ],
        "notes": "Optional comments or observations about the content GEO performance"
      }},
      "structure_geo_evaluation": {{
        "strengths": ["<brief descriptions of what is done well>"],
        "improvements": [
        ...
        "notes": "Optional comments or observations about the structure GEO performance"
      }}
    }}"""
        f"\n\nOnly return the structured JSON object above. Do not include any other text."
    )
